...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $people = $em->getRepository('UserStoriesBundle:Person')->findAll();
    ...
    {
        $person = new Person();
        $form = $this->createForm('UserStoriesBundle\Form\PersonType', $person);
    ...
    {
        $deleteForm = $this->createDeleteForm($person);
        $editForm = $this->createForm('UserStoriesBundle\Form\PersonType', $person);
